...
Gem::Specification.new do |s|
  ...
  Thank you for installing rspec-2.0.0.beta.14
...
**************************************************
  ...
  s.summary = %q{rspec-2.0.0.beta.14}
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rspec-core>, ["= 2.0.0.beta.14"])
      s.add_runtime_dependency(%q<rspec-expectations>, ["= 2.0.0.beta.14"])
      s.add_runtime_dependency(%q<rspec-mocks>, ["= 2.0.0.beta.14"])
    else
