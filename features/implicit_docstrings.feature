Feature: implicit docstrings
  ...
  docstrings for examples for you based on the last expectation in the example.This can
  be handy when the matcher expresses exactly what you would write in your example
