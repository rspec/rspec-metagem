...
Gem::Specification.new do |s|
  ...
  Thank you for installing rspec-expectations-2.0.0.beta.7
...
**************************************************
  ...
  s.summary = %q{rspec-expectations-2.0.0.beta.7}
  s.test_files = [
    "spec/rspec/expectations/differs/default_spec.rb",
     "spec/rspec/expectations/extensions/kernel_spec.rb",
     "spec/rspec/expectations/fail_with_spec.rb",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rspec-core>, [">= 2.0.0.beta.7"])
