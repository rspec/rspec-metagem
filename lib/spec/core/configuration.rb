  ...
  module Core
    class Configuration
      ...
      def initialize
        ...
        @formatter_to_use = Spec::Core::Formatters::ProgressFormatter
      ...
      def alias_example_to(new_name, extra_options={})
        Spec::Core::Behaviour.alias_example_to(new_name, extra_options)
      end
      ...
      def mock_with(make_a_mockery_with=nil)
        ...
        when /mocha/i
          require 'spec/core/mocking/with_mocha'
          Spec::Core::Mocking::WithMocha
        when /rr/i
        ...
        Spec::Core::Behaviour.send(:include, mock_framework_class)
      end
      ...
      def formatter=(formatter_to_use)
        ...
        when 'documentation' then Spec::Core::Formatters::DocumentationFormatter
        when 'progress' then Spec::Core::Formatters::ProgressFormatter
      ...
      # If true, Spec will provide detailed trace output of its self as it runs.
      ...
      def find_modules(group)
        include_or_extend_modules.select do |include_or_extend, mod, options|
          options.all? do |filter_on, filter|
            Spec::Core.world.apply_condition(filter_on, filter, group.metadata)
          end
        end
      end
